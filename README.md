...
- Regressed land usage codes on latitude in order to see that, one goes one degree farther north, how much of a given land type should one expect to see as a percentage of the total land. 
